...
describe('Service Tests', () => {
  describe('TipoServicio Service', () => {
    ...
    let expectedResult: ITipoServicio | ITipoServicio[] | boolean | null;
    beforeEach(() => {
      ...
      elemDefault = new TipoServicio(0, 'AAAAAAA', false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a TipoServicio', () => {
      ...
      it('should update a TipoServicio', () => {
        const returnedFromService = Object.assign(
          {
            nombre: 'BBBBBB',
            estado: true
      ...
      it('should return a list of TipoServicio', () => {
        const returnedFromService = Object.assign(
          {
            nombre: 'BBBBBB',
            estado: true
      ...
      it('should delete a TipoServicio', () => {
